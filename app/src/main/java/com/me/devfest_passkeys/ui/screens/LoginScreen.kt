...
import com.me.devfest_passkeys.ui.viewModel.LoginViewModel
...
@Composable
fun LoginScreen(navController: NavController, activity: ComponentActivity) {
    val viewModel: LoginViewModel by activity.viewModels<LoginViewModel>()
        ...
        Surface(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    onValueChange = { passwordError = false
                        password.value = it },
                    isError = passwordError,
                    supportingText = { if (passwordError) Text(text = "Invalid input, please type a valid password, longer than 6 characters.") },
                ...
                Button(
                    ...
                    Row(
                        ...
                        Text("Check for saved credentials", modifier = Modifier.padding(start = 8.dp))
                    }
                }
            }
        }
